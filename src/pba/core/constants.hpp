...
// Development
//
inline constexpr bool k_validate_contacts{false};

//
// Video Recorder
//
inline constexpr int k_video_recorder_fps{60};

//
// Input Handling
//
inline constexpr f32 k_zoom_speed{0.12f};
inline constexpr f32 k_sensitivity{0.0050f};
inline constexpr f32 k_pan_sensitivity{1.00f};
...
inline constexpr f32 k_angular_damping{1.5f};
...
inline constexpr f32 k_pen_max_correction{0.05f};
// This corresponds to [Box2D] linearSlop parameter
inline constexpr f32 k_pen_tolerance{0.005f};
